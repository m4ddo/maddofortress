...
#define SPORE_ROCKETS_MODEL	"models/weapons/w_models/w_sporerocket/w_sporerocket.mdl"
//=============================================================================
//
...
void CTFBaseRocket::Precache(void)
{
	...
	PrecacheModel(SPORE_ROCKETS_MODEL);
}
...
void CTFBaseRocket::Spawn(void)
{
	...
	{
		int iSporeRocket = 0;
		CALL_ATTRIB_HOOK_INT_ON_OTHER(GetLauncher(), iSporeRocket, spore_rockets);
		if (iSporeRocket)
		{
			SetModel(SPORE_ROCKETS_MODEL);
			return;
		}
		int iMiniRocket = 0;
